"""
Django settings for db_thelastofus_groupassignment project.
...
WSGI_APPLICATION = 'db_thelastofus_groupassignment.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.dummy',  # Use dummy since ORM won't be used
